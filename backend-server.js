...
app.post('/api/pedidos/actualizar-estado', (req, res) => {
  try {
    ...
    const estadosPermitidos = ['en proceso', 'asignado', 'en camino', 'entregado'];
    ...
    db.run(
      ...
      function(err) {
        ...
        // Emitir evento de actualización de estado a través de WebSocket
        // (Nota: Esto requiere que el WebSocket esté integrado con Express)
        // req.io.emit('actualizar_estado', { pedidoId, estado });
