...
app.post('/api/usuarios/registro', async (req, res) => {
  try {
    ...
    db.run(query, [usuarioId, nombres, apellidos, carnet, telefono, correo, hash], (err) => {
      if (err) {
        // Eliminar usuario de Supabase si falla en DB local
        supabase.auth.admin.deleteUser(usuarioId);
...
app.post('/api/mensajeros/registro', async (req, res) => {
  try {
    ...
    db.run(query, [mensajeroId, nombres, apellidos, carnet, telefono, tipo_vehiculo, correo, hash], (err) => {
      if (err) {
        // Eliminar usuario de Supabase si falla en DB local
        supabase.auth.admin.deleteUser(mensajeroId);
