...
app.post('/api/registro', async (req, res) => {
  try {
    ...
    const emailRedirectTo = `${frontendUrl}/confirmar.html?rol=${rol}`;
...
app.post('/api/registro/mensajero', async (req, res) => {
  try {
    ...
    // Construir URL de redirección para verificación de correo
    const frontendUrl = process.env.FRONTEND_URL || 'https://tu-frontend.com';
    // MODIFICACIÓN: Forzar rol=mensajero en la URL
    const emailRedirectTo = `${frontendUrl}/confirmar.html?rol=mensajero`;
